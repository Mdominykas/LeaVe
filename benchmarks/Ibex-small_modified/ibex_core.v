module ibex_core (
	...
	//// For contract
	wire 		retire = en_wb;
	wire [31:0] pc_retire = pc_id;
	reg 	   	rf_we_lsu_retire;
	reg 		perf_store_retire;
	reg [31:0]  instr_rdata_id_retire;
	wire [31:0]  alu_adder_result_ex_retire = alu_adder_result_ex;
	...
	assign div_op_b_ctr = rf_rdata_b_fwd_ctr_id; 

	wire div_op_zero_ctr;
	assign div_op_zero_ctr = rf_rdata_b_fwd_ctr_id == 0; 
endmodule
